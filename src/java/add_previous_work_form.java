...
public class add_previous_work_form extends HttpServlet { 
    @Override 
...
"    function hrsval()\n" +
"    {\n" +
"        hrs=document.f1.hrs.value;\n" +
                     "y = /^[0-9][0-9]:[0-5][0-9]:[0-5][0-9]$/;"+
                     "x= /^00:00:00$/;"+
"        if(hrs==\"\" || !y.test(hrs) || x.test(hrs))\n" +
"        {\n" +
"           document.getElementById(\"hrsdiv\").innerHTML=\"Enter Hours spent in proper format hh:mm:ss!\";\n" +
"              document.getElementById(\"sub\").disabled=true;\n" +
"        }\n" +
"        else\n" +
"        {\n" +
"            document.getElementById(\"hrsdiv\").innerHTML=\"&nbsp;\";\n" +
...
"        \n" +
"         <div class=\"box\" >\n" +
"        <form name=\"f1\" action=\"add_previous_work\" method=\"POST\">\n" +
                "<input type=\"hidden\" name=\"tablename\" value=\""+uname+"\">"+
                        "<input type=\"hidden\" name=\"eventid\"  value=\""+eventid+"\">\n" +
"            <table >\n" +
"                        <tr> \n" +
"                    <td>\n" +
"                        Start of Module:</td><td> <input type=\"datetime-local\" name=\"start\" value=\""+starttime+"\" oninput=\"startval()\"></td>\n" +
"                </tr>\n" +
"                <tr><td colspan=\"2\"><div id=\"startdiv\" style=\"color:red;\">&nbsp; </div></td></tr>\n" +
"                <tr> \n" +
"                    <td>\n" +
"                        End of Module:</td><td> <input type=\"datetime-local\" name=\"dline\" value=\""+deadline+"\"oninput=\"dlineval()\"></td>\n" +
"                </tr>\n" +
"                <tr><td colspan=\"2\"><div id=\"dlinediv\" style=\"color:red;\">&nbsp; </div></td></tr>\n" +
"        <tr> \n" +
"                    <td>\n" +
"                        Hours Spent:</td><td> <input type=\"text\" name=\"hrs\" value=\"05:00:00\" oninput=\"hrsval()\"></td>\n" +
"                </tr>\n" +
"                <tr><td colspan=\"2\"><div id=\"hrsdiv\" style=\"color:red;\">&nbsp; </div></td></tr>\n" +
"                <tr><td colspan=\"2\" >\n" +
"                        <input type=\"submit\" id=\"sub\" class=\"button1\" value=\"Add Details\"></td>\n" +
"                </tr>\n" +
"            </table>\n" +
"            </form>\n" +
"             </div>\n" +
...
"</html>\n");
          ...
          { 
              Logger.getLogger(add_previous_work_form.class.getName()).log(Level.SEVERE, null, ex); 
