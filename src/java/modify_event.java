...
public class modify_event extends HttpServlet { 
    @Override 
    public void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        try{ 
            ...
            stmt.executeUpdate("update "+uname+" set title='"+title+"',description='"+description+"',starttime='"+s2+"',deadline='"+s1+"' where eventid='"+eid+"'"); 
...
"</form>");
          ...
          { 
              Logger.getLogger(modify_event.class.getName()).log(Level.SEVERE, null, ex); 
